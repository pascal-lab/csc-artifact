...
public class DefaultSolver implements Solver {
    ...
    protected static final Logger logger = LogManager.getLogger(DefaultSolver.class);
    ...
    protected final ContextSelector contextSelector;
     ...
     */
    protected final boolean onlyApp;
    ...
    boolean isIgnored(JMethod method) {
     ...
     */
    protected class StmtProcessor implements StmtVisitor<Void> {
        /**
