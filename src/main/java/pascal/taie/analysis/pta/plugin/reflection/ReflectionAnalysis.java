...
public class ReflectionAnalysis implements Plugin {
    ...
    private void passReflectiveArgs(ReflectiveCallEdge edge, PointsToSet arrays) {
        ...
        Var virtualArg = edge.getVirtualArg();
        arrays.forEach(array -> {
            ...
            if (virtualArg != null && isConcerned(virtualArg.getType())) {
                solver.addPFGEdge(elems, csManager.getCSVar(calleeCtx, virtualArg), PointerFlowEdge.Kind.VIRTUAL_ARG);
            }
        });
    }
