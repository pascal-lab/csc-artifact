...
import static pascal.taie.analysis.pta.plugin.reflection.ReflectiveCallEdge.ReflectiveCallKind.METHOD_INVOKE;
import static pascal.taie.analysis.pta.plugin.reflection.ReflectiveCallEdge.ReflectiveCallKind.NEW_INSTANCE;
...
class ReflectiveActionModel extends AbstractModel {
    ...
    private void addReflectiveCallEdge(
        ...
        @Nullable CSObj recvObj, JMethod callee, Var args, ReflectiveCallEdge.ReflectiveCallKind kind) {
        ...
        ReflectiveCallEdge callEdge = new ReflectiveCallEdge(kind, csCallSite,
