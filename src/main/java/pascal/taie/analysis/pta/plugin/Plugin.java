...
public interface Plugin {
    ...
    default void onNewSetStatement(JMethod method, FieldRef fieldRef, ParameterIndex baseIndex, ParameterIndex rhsIndex) {}

    default void onNewGetStatement(JMethod method, Integer lhsIndex, ParameterIndex baseIndex, FieldRef fieldRef) {}
